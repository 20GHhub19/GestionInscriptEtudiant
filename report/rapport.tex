...
\begin{titlepage}
    ...
    \begin{tabular}{ll}
        ...
        \textbf{Gaius Heumen Nkouantchoua}        & 20303413   \\
...
La transformation du schéma E-A donne dix-huit relations. Les clés
...
\texttt{GestionInscriptEtudiant}, les 18 tables avec leurs contraintes
...
\begin{itemize}
    ...
    \item \textbf{5 requêtes complexes} (R6 à R10), toutes avec au moins
        4 tables jointes :
        \begin{enumerate}
            \item[R6.] Bulletin complet d'un étudiant (8 tables).
            \item[R7.] Moyenne pondérée par étudiant et par cours (7).
            ...
            \item[R10.] Résumé d'une session d'examen avec le prof
                responsable et la moyenne obtenue (9).
        \end{enumerate}
\end{itemize}
...
BEGIN
    ...
    -- 1) Recalcul de la lettre individuelle de chaque note touchee.
    UPDATE N
    ...
    -- 2) Recalcul de la moyenne ponderee par inscription impactee.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/home_page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dossier_etudiant.png}
    \caption{Dossier de l'étudiant --- inscriptions, notes, informations personnelles.}
    \label{fig:dossier-etudiant}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/tableau_de_bord_prof.png}
    \caption{Tableau de bord du professeur --- saisie des notes des étudiants inscrits.}
    \label{fig:dashboard-prof}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/tableau_de_board_admin.png}
    \caption{Tableau de bord de l'administrateur --- statistiques globales et top des moyennes.}
    \label{fig:dashboard-admin}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/affectation_prof_cours.png}
    \caption{Interface d'affectation d'un professeur à un cours offert.}
    \label{fig:affectation-prof-cours}
\end{figure}
...
E-A avec 18 relations toutes en 3FN, la base SQL Server avec environ
